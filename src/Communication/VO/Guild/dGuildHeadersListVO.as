package Communication.VO.Guild
{
    ...
    public class dGuildHeadersListVO implements IEventDispatcher 
    {
        ...
        public function set maxPages(_arg_1:int):void
        {
            var _local_2:Object = this._393681088maxPages;
            if (_local_2 !== _arg_1)
            {
                this._393681088maxPages = _arg_1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "maxPages", _local_2, _arg_1));
            };
        }
        ...
        {
            var _local_2:Object = this._3433103page;
            if (_local_2 !== _arg_1)
            {
                this._3433103page = _arg_1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "page", _local_2, _arg_1));
            };
        }
