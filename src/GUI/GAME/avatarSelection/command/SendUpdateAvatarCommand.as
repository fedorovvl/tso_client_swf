package GUI.GAME.avatarSelection.command
{
    ...
    public class SendUpdateAvatarCommand extends SimpleCommand 
    {
        ...
        override public function execute(_arg_1:INotification):void
        {
            ...
            _local_3.mClientMessages.SendMessagetoServer(COMMAND.UPDATE_PLAYER_INFO, _local_3.mCurrentViewedZoneID, _local_4);
        }
