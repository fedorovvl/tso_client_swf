package Modifier.Modifiers.Skins
{
    ...
    public class SkinModifier extends Modifier 
    {

        public static const xml_string:String = "skinmodifier";
        ...
        override public function modify(_arg_1:Object):Object
        {
            ...
            if ((_arg_1 is cSpecialistTask_WithSettler))
            {
                ...
                if (_local_2 != null)
                {
                    _local_2.setCustomSkin(modifierVO.name_string);
                    setModified(this);
                    return (_local_2);
                };
            };
