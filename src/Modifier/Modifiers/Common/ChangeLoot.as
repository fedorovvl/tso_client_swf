package Modifier.Modifiers.Common
{
    ...
    public final class ChangeLoot extends Modifier 
    {

        public static const xml_string:String = "changeloot";
        ...
        override public function modify(_arg_1:Object):Object
        {
            ...
            for each (_local_3 in modifierVO.effects_vector)
            {
                ...
                for each (_local_6 in _local_4)
                {
                    ...
                    {
                        if (_local_5.GetCount() != 0)
                        {
                            _local_6.SetCount(_local_5.GetCount());
                        };
                        if (_local_5.GetPrio() != 0)
                        {
                            _local_6.SetPrio(_local_5.GetPrio());
                        };
                        if (_local_5.GetRecurringChance() != 0)
                        {
                            _local_6.SetRecurringChance(_local_5.GetRecurringChance());
                        };
                        setModified(this);
                    };
                };
