package Modifier.Modifiers.Common
{
    ...
    public class FindDeposit extends Modifier 
    {

        public static const xml_string:String = "finddeposit";
        ...
        override public function modify(_arg_1:Object):Object
        {
            ...
            var _local_3:int = _local_2.numberOfExtraDeposits;
            if (modifierVO.value != 0)
            {
                _local_3 = modifierVO.value;
            };
            _local_2.numberOfExtraDeposits = int(((_local_3 * modifierVO.multiplier) + modifierVO.adder));
            setModified(this);
            return (_local_2);
        }
