package Enums
{
    public class MAIL_TYPE 
    {
        ...
        public static const BLACKMARKET_OUTBID:int = 70;
        ...
        public static const BLACKMARKET_WON:int = 69;
        ...
        public static function toString(_arg_1:int):String
        {
            switch (_arg_1)
            {
                ...
                case LOCA_MAIL:
                    return ("LocaMail");
                case BLACKMARKET_WON:
                    return ("BlackMarketAuctionWon");
                case BLACKMARKET_OUTBID:
                    return ("BlackMarketAuctionOutbid");
                default:
        ...
        public static function parse(_arg_1:String):int
        {
            ...
            if (_arg_1 == toString(BLACKMARKET_WON))
            {
                return (BLACKMARKET_WON);
            };
            if (_arg_1 == toString(BLACKMARKET_OUTBID))
            {
                return (BLACKMARKET_OUTBID);
            };
            return (MAIL);
        }
