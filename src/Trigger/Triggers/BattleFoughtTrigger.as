package Trigger.Triggers
{
    ...
    public class BattleFoughtTrigger extends DeltaTrigger implements Observer 
    {

        private var mBattlesType:Array;

        public function BattleFoughtTrigger(_arg_1:TriggerDeltaValue, _arg_2:Triggerable, _arg_3:TriggerVO, _arg_4:cGeneralInterface)
        {
            ...
            _arg_4.channels.SPECIALIST.addPropertyObserver(SpecialistNotifier.GENERAL_BATTLE_FOUGHT_string, this);
        }

        override public function dispose():void
        {
            (para as SpecialistNotifier).removePropertyObserver(SpecialistNotifier.GENERAL_BATTLE_FOUGHT_string, this);
            super.dispose();
        }
        ...
        public function update(_arg_1:Notifier, _arg_2:String, _arg_3:Object):void
        {
            ...
            if (_arg_2 == SpecialistNotifier.GENERAL_BATTLE_FOUGHT_string)
            {
