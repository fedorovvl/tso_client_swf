package Trigger.Triggers
{
    ...
    public final class QuestFailedTrigger extends InstantTrigger implements Observer 
    {

        public static var XML_string:String = "questfailed";

        public function QuestFailedTrigger(_arg_1:Triggerable, _arg_2:TriggerVO, _arg_3:cGeneralInterface)
        {
            super(_arg_1, _arg_2, _arg_3);
            _arg_2.min = (_arg_2.max = 1);
            _arg_3.channels.QUEST.addPropertyObserver(QuestChannel.QUEST_FAILED, this);
        }

        override public function dispose():void
        {
            (this.para as cGeneralInterface).channels.QUEST.removePropertyObserver(QuestChannel.QUEST_FAILED, this);
            super.dispose();
        }
        ...
        private function checkQuest(_arg_1:String):Boolean
        {
            ...
            if (((!(_local_2 == null)) && (_local_2.isFailed())))
            {
                return (true);
            };
            return (false);
