package Trigger.Triggers
{
    ...
    public class CompleteCollectionTrigger extends DeltaTrigger implements Observer 
    {
        ...
        public function CompleteCollectionTrigger(_arg_1:TriggerDeltaValue, _arg_2:Triggerable, _arg_3:TriggerVO, _arg_4:Object)
        {
        ...
        public function update(_arg_1:Notifier, _arg_2:String, _arg_3:Object):void
        {
            ...
            if (((!(definition == null)) && ((StringUtils.isEmpty(definition.item_string)) || (definition.id == _local_4.compilationId))))
            {
                getDelta().add(1);
                this.check();
            };
