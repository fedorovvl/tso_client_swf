package Trigger.Triggers
{
    ...
    public class BattleWonWithoutCasualties extends DeltaTrigger implements Observer 
    {

        private var mBattlesType:Array;

        public function BattleWonWithoutCasualties(_arg_1:TriggerDeltaValue, _arg_2:Triggerable, _arg_3:TriggerVO, _arg_4:cGeneralInterface)
        {
