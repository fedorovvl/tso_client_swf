package Trigger.Triggers
{
    ...
    public final class QuestRunningTrigger extends InstantTrigger implements Observer 
    {

        private var waitingForQuest:dQuestElementVO;

        public function QuestRunningTrigger(_arg_1:Triggerable, _arg_2:TriggerVO, _arg_3:cGeneralInterface)
        {
        ...
        override public function check():Boolean
        {
            ...
            {
                if (QuestManagerStatic.isQuestRunning(this.waitingForQuest.mQuestMode))
                {
                    trigger();
                    return (true);
                };
